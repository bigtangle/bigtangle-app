...
public class PrivacyMainActivity extends AppCompatActivity {
    ...
    private void check() {
        ...
        isCheckPrivacy = (boolean) SPUtil.get(PrivacyMainActivity.this, SP_PRIVACY, false);

        if (!isCheckPrivacy || versionCode != currentVersionCode) {
            showPrivacy();
        } else {
            Toast.makeText(PrivacyMainActivity.this, getString(R.string.confirmed), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showPrivacy() {
        ...
        final PrivacyDialog dialog = new PrivacyDialog(PrivacyMainActivity.this);
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PrivacyMainActivity.this, TermsActivity.class);
        ...
        ClickableSpan clickableSpan2 = new ClickableSpan() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PrivacyMainActivity.this, PrivacyPolicyActivity.class);
                startActivity(intent);
            }
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                SPUtil.put(PrivacyMainActivity.this, SP_VERSION_CODE, currentVersionCode);
                SPUtil.put(PrivacyMainActivity.this, SP_PRIVACY, false);
               // finish();
            }
        });
        ...
        btn_enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                SPUtil.put(PrivacyMainActivity.this, SP_VERSION_CODE, currentVersionCode);
                SPUtil.put(PrivacyMainActivity.this, SP_PRIVACY, true);

                Toast.makeText(PrivacyMainActivity.this, getString(R.string.confirmed), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(PrivacyMainActivity.this, VerifyWalletActivity.class);
